...
class StoreScreen extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      aboutContent2Zh: "", // 中心簡介的預設值(中文)
      aboutContent2En: "", // 中心簡介的預設值(英文)
      aboutImageData: [],
...
export default connect(
  (state) => ({
    ...
    teamList: state.store.teamList,
    teacherList: state.store.teacherList,
    teacherInfo: state.store.teacherInfo,
    screenHeight: state.screen.screenHeight,
  }),
  (dispatch) =>
    bindActionCreators(
      {
        getStore: StoreActions.getStore,
        updateStore: StoreActions.updateStore,

        getTeamList: StoreActions.getTeamList,
        updateTeamList: StoreActions.updateTeamList,

        getTeacherList: StoreActions.getTeacherList,
        getTeacherInfo: StoreActions.getTeacherInfo,
        createTeacher: StoreActions.createTeacher,
        updateTeacher: StoreActions.updateTeacher,
        deleteTeacher: StoreActions.deleteTeacher,
        updateTeacherOrder: StoreActions.updateTeacherOrder,
      },
      dispatch
    )
)(StoreScreen);
