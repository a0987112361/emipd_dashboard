...
export default connect(
  (state) => ({
    ...
    activityPicList: state.activity.activityPicList,
    picPaging: state.activity.picPaging,
  ...
  (dispatch) =>
    bindActionCreators(
      {
        getActivityList: ActivityActions.getActivityList,
        getActivityPicList: ActivityActions.getActivityPicList,
        getActivityInfo: ActivityActions.getActivityInfo,
