...
import "./Store2Screen.css";
import _ from "lodash";
import { Store2Actions } from "../../Stores";
...
class Store2Screen extends React.Component {
  constructor(props) {
    super(props);
...
export default connect(
  (state) => ({
    ...
    teamList: state.store2.teamList,
    teacherList: state.store2.teacherList,
    teacherInfo: state.store2.teacherInfo,
    screenHeight: state.screen.screenHeight,
  }),
  (dispatch) =>
    bindActionCreators(
      {
        getStore: Store2Actions.getStore2,
        updateStore: Store2Actions.updateStore2,

        getTeamList: Store2Actions.getTeam2List,
        updateTeamList: Store2Actions.updateTeam2List,

        getTeacherList: Store2Actions.getTeacher2List,
        getTeacherInfo: Store2Actions.getTeacher2Info,
        createTeacher: Store2Actions.createTeacher2,
        updateTeacher: Store2Actions.updateTeacher2,
        deleteTeacher: Store2Actions.deleteTeacher2,
        updateTeacherOrder: Store2Actions.updateTeacher2Order,
      },
      dispatch
    )
)(Store2Screen);
