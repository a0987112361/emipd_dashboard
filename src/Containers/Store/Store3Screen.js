...
const teacherList = [
  ...
  },
  {
    ...
    study: ["教學測驗與評量", "外語習得", "課程設計與評鑑", "師資培訓"],
  },
  {
...
class Store3Screen extends React.Component {
    ...
    this.setState(
      ...
      () => {
        if (currentKey === 1) {
          ...
          getZhTeacherList(searchValue, teacherCallback, this.errorCallback);
        } else if (currentKey === 5) {
          getEnTeacherList(searchValue, teacherCallback, this.errorCallback);
        }
      }
    );
  };
  ...
  handleUpdateTeamList = () => {
    ...
    columnChangeTeamForm.map((item, index) => {
      newIds.push(item.team_id);
    });
    teamList.map((item, index) => {
      originIds.push(item.team_id);
    });

    if (originIds.length !== newIds.length) {
      // del
      originIds.map((item) => {
  ...
  handleSearch = (e) => {
    ...
    const handleGetList = () => {
      const teacherCallback = (data) => {
        if (_.has(data, "list") && _.isArray(data.list)) {
          this.setState({
            currentTeacherList: data.list,
          });
        }
        this.setState({
          isLoading: false,
  ...
  // 師資陣容搜尋
  handleEnSearch = (e) => {
    const { getEnTeacherList } = this.props;
    let value = e.target.value;

    const handleGetList = () => {
      const teacherEnCallback = (data) => {
        if (_.has(data, "list") && _.isArray(data.list)) {
          this.setState({
            currentTeacherList: data.list,
          });
      ...
      if (value === "") {
        this.setState(
          ...
          () => getEnTeacherList("", teacherEnCallback, this.errorCallback)
        );
      } else {
        this.setState(
          {
          ...
          () => getEnTeacherList(value, teacherEnCallback, this.errorCallback)
        );
      }
    };
  ...
  // 師資陣容搜尋
  handleZhSearch = (e) => {
    const { getZhTeacherList } = this.props;
    let value = e.target.value;

    const handleGetList = () => {
      const teacherZhCallback = (data) => {
      ...
      if (value === "") {
        this.setState(
          ...
          () => getZhTeacherList("", teacherZhCallback, this.errorCallback)
        );
      } else {
        this.setState(
          {
          ...
          () => getZhTeacherList(value, teacherZhCallback, this.errorCallback)
        );
      }
    };
        ...
        >
          ...
          <div>
            ...
            <HtmlEditor
              ...
              onEditorStateChange={(value) =>
                this.handleChangeContent("aboutContent2Zh", value)
              }
            />
            ...
            <HtmlEditor
              ...
              onEditorStateChange={(value) =>
                this.handleChangeContent("aboutContentZh", value)
              }
            />
          </div>
          ...
          <div style={{ marginTop: "25px" }}>
            ...
            <HtmlEditor
              ...
              onEditorStateChange={(value) =>
                this.handleChangeContent("aboutContent2En", value)
              }
            />
            ...
            <HtmlEditor
              ...
              onEditorStateChange={(value) =>
                this.handleChangeContent("aboutContentEn", value)
              }
            />
          </div>
    ...
    return (
      <div style={{ width: "100%", padding: "25px" }}>
        ...
        >
          ...
          >
            <Col span={5} style={{ padding: "8px 16px" }}>
              職稱
            </Col>
            <Col span={5} style={{ padding: "8px 0px" }}>
              姓名
            </Col>
            <Col span={4} style={{ padding: "8px 0px" }}>
              稱呼
            </Col>
                    ...
                    >
                      ...
                      >
                        <SortButton
                          ...
                          handleClickUp={() =>
                            this.handleSortTeamColumn(index, -1)
                          }
                          handleClickDown={() =>
                            this.handleSortTeamColumn(index, 1)
                          }
  ...
  handleDelete = (id) => {
    const { deleteTeacher, deleteZhTeacher, deleteEnTeacher } = this.props;
    const { searchValue, tab } = this.state;
    let payload = [];
    payload.push(id);
    const callback = (data) => {
      if (_.has(data, "list") && _.isArray(data.list)) {
    ...
    this.setState(
      ...
      () => {
        if (tab === 3) {
          ...
          deleteZhTeacher(payload, searchValue, callback, this.errorCallback);
        } else if (tab === 5) {
          deleteEnTeacher(payload, searchValue, callback, this.errorCallback);
        }
      }
    );
  };
  ...
  onSortEnd = ({ oldIndex, newIndex, collection }) => {
    ...
    console.log("[...this.state.currentTeacherList] =>", [
      ...this.state.currentTeacherList,
    ]);
  ...
  submitTeacherOrder = () => {
    const { updateTeacherOrder, updateEnTeacherOrder, updateZhTeacherOrder } =
      this.props;
    const { newTeacherList, searchValue, tab } = this.state;
  ...
  handleTeacherModal = (mode, teacherId) => {
    const { getTeacherInfo, getEnTeacherInfo, getZhTeacherInfo } = this.props;
    ...
    const callback = (value) => {
      ...
      let data = {
        ...
        teacher_appe_zh:
          value.teacher_appe_zh !== undefined &&
          value.teacher_appe_zh !== null &&
          value.teacher_appe_zh !== "null" &&
          value.teacher_appe_zh !== ""
            ? value.teacher_appe_zh
            : "",
        teacher_appe_en:
          value.teacher_appe_en !== undefined &&
          value.teacher_appe_en !== null &&
          value.teacher_appe_en !== "null" &&
          value.teacher_appe_en !== ""
            ? value.teacher_appe_en
            : "",
      };
      ...
      this.setState(
        ...
        () => {
          if (tab === 3) {
            ...
            getZhTeacherInfo(teacherId, callback, this.errorCallback);
          } else if (tab === 5) {
            getEnTeacherInfo(teacherId, callback, this.errorCallback);
          }
        }
      );
    } else {
  ...
  handleSubmitTeacher = (value) => {
    ...
    const {
      ...
      teacherImgData,
      teacherId,
      columnChangeTeacherForm,
      columnChangeTeacherEnForm,
      searchValue,
      tab,
    } = this.state;
    ...
    if (teacherMode === "update") {
      ...
      if (!_.has(teacherImgData[0], "originFileObj")) {
        // 如果沒有重新上傳的動作
      ...
      () => {
        if (teacherMode === "create") {
          if (tab === 3) {
            ...
            createZhTeacher(formData, callback, this.errorCallback);
          } else if (tab === 5) {
            createEnTeacher(formData, callback, this.errorCallback);
          }
        } else {
          if (tab === 3) {
  ...
  renderTeacherModal = () => {
    ...
    return (
      <Modal
        ...
        centered
        onCancel={() =>
          this.setState({ teacherModalVisible: false, teacherImgData: [] })
        }
        footer={null}
        maskClosable={false}
      >
        ...
        >
          ...
          <Row style={{ margin: "20px 0px", rowGap: "12px" }} gutter={24}>
            ...
            <Col span={24}>
              ...
              <Form.List name="teacherColumns" required>
                {(fields, { add, remove }) => (
                  <div>
                    {fields.map((field, index, arr) => (
                      <Row
                        ...
                        >
                          ...
                          >
                            <SortButton
                              ...
                              length={fields.length}
                              handleClickUp={() =>
                                this.handleSortTeacherColumn(index, -1)
                              }
                              handleClickDown={() =>
                                this.handleSortTeacherColumn(index, 1)
                              }
          ...
          <Row style={{ margin: "20px 0px", rowGap: "12px" }} gutter={24}>
            ...
            <Col span={24}>
              ...
              <Form.List name="teacherEnColumns" required>
                {(enFields, { add, remove }) => (
                  <div>
                        ...
                        >
                          ...
                          >
                            <SortButton
                              ...
                              handleClickUp={() =>
                                this.handleSortTeacherEnColumn(index, -1)
                              }
                              handleClickDown={() =>
                                this.handleSortTeacherEnColumn(index, 1)
                              }
  ...
  render() {
    ...
    const SortableItem = sortableElement(({ item }) => (
      <Col
        ...
        lg={4}
        xl={4}
        style={{ cursor: isMoveTeacher ? "grab" : "default" }}
      >
        <div
          style={{
        ...
        >
          ...
          <Row style={{ borderTop: "1px solid #c2d7e6" }}>
            <Col
              span={24}
              style={{
                display: isMoveTeacher ? "flex" : "none",
                justifyContent: "center",
                alignItems: "center",
                height: "40px",
              }}
            ...
            <Col
              span={12}
              style={{
                display: isMoveTeacher ? "none" : "flex",
                justifyContent: "center",
                alignItems: "center",
                height: "40px",
                borderRight: "1px solid #c2d7e6",
              }}
            >
              <img
                src={Images.edit}
                ...
                onClick={() =>
                  this.handleTeacherModal("update", item.teacher_id)
                }
              />
            </Col>
            <Col
    ...
    const SortableList = sortableContainer(({ items }) => (
      <Row
        style={{ width: "100%", margin: "20px -12px", rowGap: "24px" }}
        gutter={24}
      >
      ...
      <div style={{ width: "100%", height: "100%" }}>
        ...
        <div style={styles.root}>
          <div style={styles.wrapper}>
            <div style={styles.contentTop}>關於中心管理</div>
            <div
            ...
            >
              <Tabs defaultActiveKey={tab} onChange={this.handleTabChange}>
                ...
                <TabPane
                  tab="師資陣容"
                  key={3}
                  style={{ ...styles.tabStyle, padding: "25px" }}
                >
                  <div
                    style={{
                      width: "100%",
                  ...
                  >
                    ...
                    >
                      ...
                      <Button
                        ...
                        onClick={() => this.handleTeacherModal("create", "")}
                        disabled={isMoveTeacher}
                      >
                        <img
                          src={Images.add}
                  ...
                  {isMoveTeacher && (
                    ...
                    >
                      <Button
                        ...
                        htmlType="submit"
                        loading={isLoading}
                        onClick={this.submitTeacherOrder}
                      >
                        儲存
                      </Button>
                    </div>
                ...
                >
                  ...
                  <Row
                    ...
                    gutter={24}
                  >
                    {teacherZhList.length > 0 &&
                      teacherZhList.map((item) => {
                        return <div></div>;
                      })}
                  </Row>
                </TabPane>
                ...
                >
                  ...
                  <Row
                    ...
                    gutter={24}
                  >
                    {teacherEnList.length > 0 &&
                      teacherEnList.map((item) => {
                        return <div></div>;
                      })}
                  </Row>
                </TabPane>
...
export default connect(
  (state) => ({
    ...
    teacherEnList: state.store3.teacherEnList,
    teacherEnInfo: state.store3.teacherEnInfo,
    teacherZhList: state.store3.teacherZhList,
    teacherZhInfo: state.store3.teacherZhInfo,
    ...
    bindActionCreators(
      {
        ...
        getEnTeacherList: Store3Actions.getTeacherEnList,
        getEnTeacherInfo: Store3Actions.getTeacherEnInfo,
        createEnTeacher: Store3Actions.createTeacherEn,
        updateEnTeacher: Store3Actions.updateTeacherEn,
        deleteEnTeacher: Store3Actions.deleteTeacherEn,
        updateEnTeacherOrder: Store3Actions.updateTeacherEnOrder,

        getZhTeacherList: Store3Actions.getTeacherZhList,
        getZhTeacherInfo: Store3Actions.getTeacherZhInfo,
        createZhTeacher: Store3Actions.createTeacherZh,
        updateZhTeacher: Store3Actions.updateTeacherZh,
        deleteZhTeacher: Store3Actions.deleteTeacherZh,
        updateZhTeacherOrder: Store3Actions.updateTeacherZhOrder,
      },
      dispatch
    )
)(Store3Screen);
