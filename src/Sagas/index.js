...
export default function* root() {
  yield all([
    ...
    takeLatest(PropertyTypes.GET_PROPERTY_DETAIL, PropertySaga.getPropertyDetail),
    ...
    takeLatest(PropertyTypes.CHANGE_PROPERTY_SORT, PropertySaga.changePropertySort),
    ...
    takeLatest(DeliveryTypes.GET_DELIVERY_DETAIL, DeliverySaga.getDeliveryDetail),
    ...
    takeLatest(Store2Types.UPDATE_TEACHER2_ORDER, Store2Saga.updateTeacher2Order),
    ...
    takeLatest(Store3Types.UPDATE_TEACHER3_ORDER, Store3Saga.updateTeacher3Order),
    ...
    takeLatest(ActivityTypes.GET_ACTIVITY_PIC_LIST, ActivitySaga.getActivityPicList),
    ...
    // activity2
    takeLatest(Activity2Types.GET_ACTIVITY2_LIST, Activity2Saga.getActivity2List),
    takeLatest(Activity2Types.GET_ACTIVITY2_PIC_LIST, Activity2Saga.getActivity2PicList),
    takeLatest(Activity2Types.GET_ACTIVITY2_INFO, Activity2Saga.getActivity2Info),
    ...
    // activity3
    takeLatest(Activity3Types.GET_ACTIVITY3_LIST, Activity3Saga.getActivity3List),
    takeLatest(Activity3Types.GET_ACTIVITY3_PIC_LIST, Activity3Saga.getActivity3PicList),
    takeLatest(Activity3Types.GET_ACTIVITY3_INFO, Activity3Saga.getActivity3Info),
